...
import DOM.Erumu.HTML.Attributes (action, alt, araiOrientation, ariaExpanded, ariaHaspopup, ariaHidden, ariaLabelledby, ariaModal, autocomplete, autofocus, cRadius, checked, classN_, class_, classes, clipRule, colSpan, cxCoord, cyCoord, dataClipboardText, dataLegId, dataPopupName, dataPopupOpens, data_, defaultValue, defer, dims, disabled, enctype, fill, fillRule, fontFamily, fontSize, for, gradientUnits, height, href, id_, method, name, noop, offset, placeholder, points, role, rows, rx, selected, src, stroke, strokeLinecap, strokeLinejoin, strokeWidth, style, tabindex, target, title, transform, type_, value, viewBox, width, x1Coord, x2Coord, xCoord, xmlns, y1Coord, y2Coord, yCoord) as Attributes
